...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://github.com/hectorcarrion/hectorcarrion.github.io/blob/main/Hector%20Carrion%20Resume%20Oct%202023.pdf?raw=true" variant="secondary" className="group mt-6 w-full">
        Download Resume
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Hi I’m Héctor, CS PhD at UCSC, Advisor at tera.earth and visia.ai."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          &nbsp;- Multi-modal, self-supervised AI reserach for real-world positive impacts 🌱
          </p>
